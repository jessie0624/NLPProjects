...
# for subpth in [encoder_save_name,decoder_save_name, attention_save_name,reduce_state_save_name ]
if not os.path.exists(encoder_save_name):
    os.mkdirs(encoder_save_name)
