...
class DataProcessForSentence(Dataset):
    ...
    def get_input(self, file):
        ...
        # get other features: BM25 score, lcs, 
        # pair_score = df[['bm25', 'lcs', 'edit_dist', 'jaccard', 'w2v_cos', 'w2v_eucl', 'w2v_pearson', 'w2v_wmd','fast_cos','fast_eucl','fast_pearson','fast_wmd']].values.tolist()
